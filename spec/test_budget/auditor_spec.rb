...
RSpec.describe TestBudget::Auditor do
  ...
  it "returns per_test_case violations" do
    ...
    violations = auditor.audit(make_test_run([make_test_case(duration: 3.0)]))
  ...
  it "returns suite violations" do
    ...
    violations = auditor.audit(make_test_run([make_test_case(duration: 3.0), make_test_case(name: "other", duration: 3.0)]))
  ...
  it "returns empty when all pass" do
    ...
    violations = auditor.audit(make_test_run([make_test_case(duration: 1.0)]))
